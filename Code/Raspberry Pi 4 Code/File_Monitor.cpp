...
namespace File_Monitor_Parameters {
    ...
    string Created_Image_File_Name;
}

//------------------------Constructor definitions--------------------------
File_Monitor::File_Monitor(string Directory_Path_)
...
string File_Monitor::get_Directory_Path() const {
    return Directory_Path;
}
//---------------------------------------------------------

//-------------------set function definitions--------------
void File_Monitor::set_Directory_Path(string _Directory_Path) {
                ...
                if (event->mask & IN_CREATE) {
                    if (!(event->mask & IN_ISDIR)) {
                        ...
                        if (dot && !strcmp(dot, ".dng")) {
                        	...
                        	cout << "tiff here" << endl;
                        	cout << "rpi save direc: " << Directory_Parameters::Confirmed_Correct_RPi_Save_Directory << endl;
                        	
                        	//-----This moves the tiff to the tiff folder
                        	string Tiff_Directory_Location = Directory_Parameters::Confirmed_Correct_RPi_Save_Directory + "/tiff";
                        	string File_Name_No_Extension = removeExtension(File_Monitor_Parameters::Created_Image_File_Name);
                        	string Move_Tiff_To_Tiff_Folder_Command = "mv " + Directory_Parameters::Confirmed_Correct_RPi_Save_Directory + "/" + File_Name_No_Extension + ".tiff" + " " + Tiff_Directory_Location;
                        	...
                        	string Png_Directory_Location = Directory_Parameters::Confirmed_Correct_RPi_Save_Directory + "/png";
                        	string File_Name_No_Extension = removeExtension(File_Monitor_Parameters::Created_Image_File_Name);                        	
                        	string Move_Png_To_Png_Folder_Command = "mv " + Directory_Parameters::Confirmed_Correct_RPi_Save_Directory + "/" + File_Name_No_Extension + ".png" + " " + Png_Directory_Location;
                        	...
                        	string Dng_Directory_Location = Directory_Parameters::Confirmed_Correct_RPi_Save_Directory + "/dng";
                            string Move_Dng_To_Tiff_Folder_Command = "mv " + Directory_Parameters::Confirmed_Correct_RPi_Save_Directory + "/" + File_Name_No_Extension + ".dng" + " " + Dng_Directory_Location;
